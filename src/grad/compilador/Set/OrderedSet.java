 ...
 *   CLASSE OrderedSet                                                                                     *
 * ------------------------------------------------------------------------------------------------------- *
 *   Implementa um conjunto genérico.                                                                      *
 *                                                                                                         *
...
public class OrderedSet
{
   ...
   *    cada elemento do conjunto estará associado à sua posição na lista duplamente ligada.
   */
  Dictionary dictionary;                  // tabela de hash
  private DoubleLinkedList first, last;   // ponteiros para o primeiro e último elementos da lista ligada
  int size;                               // tamanho do conjunto (número de elementos)
  String name;                            // nome do conjunto (opcional)

  public boolean show = false;      // flag de debug: se ativada, mostra o conjunto a cada atualização
  public boolean showErro = true;   // flag de debug: se ativada, mostra mensagem de erro ao acrescentar um
                                    //                elemento que já existe ou ao tentar remove um elemento
  ...
  /* construtor OrderedSet (String name)
   ...
   *    acrescenta um elemento ao conjunto (por default, no final dele).
   */
  public boolean add (Object o) {return addLast(o);}

  /* boolean addFirst (Object o)
   *    acrescenta um elemento ao conjunto, no ínicio; retorna false se o elemento pertence a este conjunto,
   *    e true caso contrário.
   */
  public boolean addFirst (Object o) {
    if (o==null || has(o)) {
      if (showErro||show) System.out.println("ERRO ao acrescentar "+o+" em "+this);
      return false;
    }
    if (show) System.out.println("  Inserindo "+o+" em "+this);
    ...
    size++;
    if (show) System.out.println("   Inserido "+o+" em "+this);
    return true;
  }
   ...
   *    remove o elemento deste conjunto; retorna false se o elemento não pertence a este conjunto, e true
   *    caso contrário.
   */
  public boolean remove (Object o) {
    if (o==null || size==0) {
      if (showErro||show) System.out.println("ERRO ao remover "+o+" de "+this);
      return false;
    }
    ...
    if (show) System.out.println("  Removendo "+o+" de "+this);
    ...
    dictionary.remove(o);
    size--;
    if (show) System.out.println("   Removido "+o+" de "+this);
    return true;
  }

  /* boolean has (Object o)
   *    verifica se o elemento pertence a este conjunto.
   */
  ...
  /* boolean isEqualTo (OrderedSet set)
  ...
  /* Object getFirst()
   *    retorna o primeiro elemento deste conjunto.
   */
  ...
  /* Object getLast()
   *    retorna o último elemento deste conjunto.
   */
  ...
  /* Object getPrev (Object o)
   *    retorna o elemento deste conjunto anterior ao fornecido.
   */
  ...
  /* Object getPrev (Object o)
   *    retorna o elemento deste conjunto posterior ao fornecido.
   */
