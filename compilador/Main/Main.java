...
class Main {
	...
	frameproc = f.frame.procEntryExit3(instrs); // construimos o corpo da funcao
	...
	for (i = 1; i <= args.length; i++) {
	    if (args[i-1].equals("-v")) deb = true; // verbose on
	    else if (args[i-1].equals("-h")) help(); // mensagem de help
	    else break; // nao e' opcao de linha de comando -> e' arquivo
	}
	...
	java.io.PrintStream out = 
	    new java.io.PrintStream(new java.io.FileOutputStream(filename + ".s"));
