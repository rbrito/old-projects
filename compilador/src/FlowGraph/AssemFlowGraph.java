 ...
 * ------------------------------------------------------
 * ------------------------------------------------- * Cria um grafo
 * representando o fluxo de um conjunto de instruções. *
 ***********************************************************************************************************/
...
public class AssemFlowGraph extends FlowGraph {
    ...
    /*
     * construtor AssemFlowGraph (InstrList instrs) a partir de um conjunto de
     * instruções, cria um grafo representando o fluxo do programa; para isso,
     * utilliza a informação sobre possíveis desvios que cada instrução assembly
     * pode realizar.
     */
    public AssemFlowGraph(InstrList instrs) {
        ...
        for (; instrs != null; instrs = instrs.tail) {
            ...
            if (instrs.head instanceof OPER
                    && ((OPER) instrs.head).jumps() != null) {
                // cria uma aresta entre este nó e todos aqueles para o qual a
                // instrução assembly pode desviar
    ...
    /*
     * Node getNodeDefiningLabel (Label label) devolve o nó associado à
     * instrução que faz a declaração do rótulo especificado (esta declaração
     * pode não estar presente no conjunto de instruções assembly que estão
     * sendo analisadas).
     */
    ...
    /*
     * TempList def (Node n) retorna o conjunto com os temporários definidos por
     * esta instrução assembly (nó).
     */
    ...
    /*
     * TempList def (Node n) retorna o conjunto com os temporários usados por
     * esta instrução assembly (nó).
     */
    ...
    /*
     * boolean isMove (Node n) verifica se este nó está associado a uma
     * instrução MOVE.
     */
    ...
    /*
     * Instr instr (Node n) retorna a instrução assembly associada a este nó.
     */
