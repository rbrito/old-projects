 ...
 * CLASSE Escape *
 * --------------------------------------------------------------
 * ----------------------------------------- * Guarda informações sobre onde as
 * variáveis foram declaradas e sobre se escapam ou não. *
 ***********************************************************************************************************/
 ...
 * CLASSE FormalEscape *
 * --------------------------------------------------------
 * ----------------------------------------------- * Guarda informações sobre em
 * que nível os parâmetros de uma função foram declarados e se escapam ou * não.
 * *
 ***********************************************************************************************************/
 ...
 * --------------------------------------------------------
 * ----------------------------------------------- * Guarda informações sobre em
 * que nível uma variável foi declarada e se escapa ou não. *
 ***********************************************************************************************************/

// Classe VarEscape: armazena uma variável e a profundidade em que foi
// declarada.
 ...
 * abstrata determinando quais as variáveis e parâmetros que escapam e * quais
 * não. *
 ***********************************************************************************************************/
...
public class FindEscape {
    ...
    void traverseVar(int depth, Absyn.SimpleVar v) {
        ...
        // verifica se esta variável ou parâmetro formal está sendo usada em um
        // nível mais interno ao da sua
        // declaração
        if ((escape != null) && (depth > escape.depth))
            escape.setEscape(); // esta variável/parâmetro escapa (precisará
                                // ficar no frame, não em registrador)
    }
    ...
    void traverseExp(int depth, Absyn.Exp e) {
        if ((e instanceof Absyn.NilExp) || (e instanceof Absyn.IntExp)
    ...
    void traverseDec(int depth, Absyn.VarDec d) {
        // declara uma variável e armazena a profundidade e a função dentro da
        // qual foi declarada
    ...
    void traverseDec(int depth, Absyn.FunctionDec d) {
        for (Absyn.FunctionDec dd = d; dd != null; dd = dd.next) {
            ...
            for (Absyn.FieldList p = dd.params; p != null; p = p.tail)
                // declara um parâmetro formal e armazena a profundidade em que
                // foi declarado
