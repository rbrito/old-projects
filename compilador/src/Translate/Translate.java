...
public class Translate {
    ...
    public Exp strcmpExp(int op, Exp e1, Exp e2, Level l) {
        Exp tmp = new Ex(l.frame.externalCall("stringEqual", new Tree.ExpList(
                e1.unEx(), new Tree.ExpList(e2.unEx(), null))));
        ...
        case Absyn.OpExp.NE:
            return new Ex(l.frame.externalCall("not",
                    new Tree.ExpList(tmp.unEx(), null)));
        default:
    ...
    public Exp callExp(Temp.Label flabel, ExpList el, Level l) {
        ...
        if (funcao.equals("print") || funcao.equals("ord")
                || funcao.equals("size") || funcao.equals("substring")
                || funcao.equals("not") || funcao.equals("flush")
                || funcao.equals("chr") || funcao.equals("concat")
                || funcao.equals("getchar") || funcao.equals("exit")) {
    ...
    public Exp recordExp(int n, ExpList el, Level l) {
        ...
        return new Ex(new Tree.ESEQ(new Tree.SEQ(new Tree.MOVE(
                new Tree.TEMP(t), l.frame.externalCall("allocRecord",
                        new Tree.ExpList(new Tree.CONST(n * ws), null))), s),
                new Tree.TEMP(t)));
    }
    ...
    public Exp arrayExp(Exp e1, Exp e2, Level l) {
        Temp.Temp t = new Temp.Temp();
        Tree.Exp e = l.frame.externalCall("initArray",
                new Tree.ExpList(e1.unEx(), new Tree.ExpList(e2.unEx(), null)));

        return new Ex(new Tree.ESEQ(new Tree.MOVE(new Tree.TEMP(t), e),
                new Tree.TEMP(t)));
    ...
    public Exp whileExp(Exp test, Exp body, Temp.Label end) {
        ...
        return new Nx(new Tree.SEQ(new Tree.LABEL(t), new Tree.SEQ(test.unCx(a,
                end), new Tree.SEQ(new Tree.LABEL(a), new Tree.SEQ(body.unNx(),
                new Tree.SEQ(new Tree.JUMP(t), new Tree.LABEL(end)))))));
    }
    ...
    public Exp fieldVar(Exp e, int n, Level l) {
        ...
        return new Ex(new Tree.MEM(new Tree.BINOP(Tree.BINOP.PLUS, e.unEx(),
                new Tree.BINOP(Tree.BINOP.MUL, new Tree.CONST(n),
                        new Tree.CONST(ws)))));
    }
    ...
    public Exp subscriptVar(Exp e, Exp index, Level l) {
        ...
        return new Ex(new Tree.MEM(
                new Tree.BINOP(Tree.BINOP.PLUS, e.unEx(), new Tree.BINOP(
                        Tree.BINOP.MUL, index.unEx(), new Tree.CONST(ws)))));
    }
}
